      ...
      child: BlocBuilder<ServiceScreenViewModel, ServiceStates>(
        builder: (context, state) {
          if (state is ServiceLoadingState) {
            ...
            if (_focusedDay.isBefore(fromDate) || _focusedDay.isAfter(toDate)) {
                  ...
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(
                        ...
                        style: TextStyle(color: Color(0xFF3DAB25), fontWeight: FontWeight.bold),
                      ),
                    ),
                    TableCalendar(
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: ListView.builder(
                          itemCount: serviceViewModel.agentCalenderList?.length ?? 0,
                          itemBuilder: (context, index) {
                            final agent = serviceViewModel.agentCalenderList![index];
                            final initialSelectedTimeSlot = '4';
                            final availableTimeSlots = agent.slots!.split(',').map((slot) => slot.trim()).toList();
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return OutlinedButton(
                                          ...
                                          style: OutlinedButton.styleFrom(
                                            backgroundColor: isSelected ? Color(0xFF12A770) : Colors.white,
                                            side: BorderSide(
                                              color: isSelected ? Color(0xFF12A770) : Colors.grey,
                                            ),
